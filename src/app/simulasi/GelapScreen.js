    ...
    <div className={`sim-screen sim-detail sim-detail-gelap ${active ? "active" : ""}`}>
      ...
      <div className="sim-detail-canvas">
        <svg viewBox="0 0 760 260">
          ...
          <text x="130" y="100" fontSize="8" fontWeight="700" fill="#90a4ae">Fiksasi CO₂</text>
          <text x="130" y="111" fontSize="8" fill="#7986cb">(Rubisco)</text>
          ...
          <text x="375" y="75" textAnchor="middle" fontSize="8" fontWeight="700" fill="#CE93D8">dari Reaksi Terang</text>
          ...
          <g transform="translate(375,145)">
            ...
            <text x="0" y="-55" textAnchor="middle" fontSize="7" fill="white" fontWeight="700">RuBP</text>
            <circle cx="65" cy="0" r="10" fill="#4FC3F7"><animate attributeName="opacity" values="0.4;1;0.4" dur="1.2s" repeatCount="indefinite"/></circle>
            <text x="65" y="4" textAnchor="middle" fontSize="7" fill="white" fontWeight="700">3-PGA</text>
            ...
            <text x="0" y="69" textAnchor="middle" fontSize="7" fill="white" fontWeight="700">PGAL</text>
            ...
            <text x="-65" y="4" textAnchor="middle" fontSize="7" fill="white" fontWeight="700">G3P</text>
          </g>
          ...
          <text x="530" y="138" textAnchor="middle" fontSize="8" fontWeight="700" fill="#81C784">sintesis</text>
          <text x="530" y="150" textAnchor="middle" fontSize="8" fill="#7986cb">PGAL → Glukosa</text>
